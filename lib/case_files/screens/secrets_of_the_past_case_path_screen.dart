...
import 'secrets_of_the_past_mission_screen.dart';

class SecretsOfThePastCasePathScreen extends StatefulWidget {
  const SecretsOfThePastCasePathScreen({super.key});

  static const String _assetBase =
      'assets/images/case_paths/secrets_of_the_past';

  @override
  State<SecretsOfThePastCasePathScreen> createState() =>
      _SecretsOfThePastCasePathScreenState();
}

class _SecretsOfThePastCasePathScreenState
    extends State<SecretsOfThePastCasePathScreen> {
...
class _MapBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Image.asset(
      '${SecretsOfThePastCasePathScreen._assetBase}/secrets_of_the_past_map.webp',
      fit: BoxFit.fill,
      alignment: Alignment.topCenter,
...
class _SecretsOfThePastHeader extends StatelessWidget {
  const _SecretsOfThePastHeader();

  @override
  Widget build(BuildContext context) {
    return Center(
      child: Image.asset(
        '${SecretsOfThePastCasePathScreen._assetBase}/secrets_of_the_past_header.webp',
        fit: BoxFit.contain,
