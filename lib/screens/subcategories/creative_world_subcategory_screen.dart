...
class CreativeWorldSubcategoryScreen extends StatefulWidget {
  const CreativeWorldSubcategoryScreen({super.key});

  @override
  State<CreativeWorldSubcategoryScreen> createState() =>
      _CreativeWorldSubcategoryScreenState();
}

class _CreativeWorldSubcategoryScreenState
    extends State<CreativeWorldSubcategoryScreen> {
  ...
  Future<void> _loadPlayedQuestionCounts() async {
    ...
    for (final _CreativeWorldSubcategory item in _items) {
  ...
  Future<void> _loadFirebaseSubcategoryAvailability() async {
    try {
      final List<Future<QuerySnapshot<Map<String, dynamic>>>> checks =
          _items.map((_CreativeWorldSubcategory item) {
        return FirebaseFirestore.instance
            .collection('challenges')
            .where('category', isEqualTo: 'creative_world')
  ...
  Future<void> _openSubcategory(
    _CreativeWorldSubcategory item,
  ) async {
            ...
            Expanded(
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  final _CreativeWorldSubcategory item =
                      _items[index];
...
class _CreativeWorldCard extends StatelessWidget {
  const _CreativeWorldCard({
    required this.item,
