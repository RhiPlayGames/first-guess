...
class ScienceNatureSubcategoryScreen extends StatefulWidget {
  const ScienceNatureSubcategoryScreen({super.key});

  @override
  State<ScienceNatureSubcategoryScreen> createState() =>
      _ScienceNatureSubcategoryScreenState();
}

class _ScienceNatureSubcategoryScreenState
    extends State<ScienceNatureSubcategoryScreen> {
  ...
  Future<void> _loadPlayedQuestionCounts() async {
    ...
    for (final _ScienceNatureSubcategory item in _items) {
...
class _ScienceNatureCard extends StatelessWidget {
  const _ScienceNatureCard({
    required this.item,
