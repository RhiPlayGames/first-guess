...
TARGET_SUBCATEGORY = "mammals"

OLD_DOCUMENT_IDS = [
    f"animals_mammals_{i:04d}"
    for i in range(1, 21)
]
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Safely remove only the 20 old Animals -> Mammals "
    ...
    print("FIRST GUESS — REMOVE OLD MAMMALS FIRESTORE QUESTIONS")
    print("=" * 72)
    ...
    if not args.write:
        ...
        print("    python delete_old_mammals_firestore.py --write")
        return
